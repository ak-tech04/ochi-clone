  ...
  return (
    <div>
      <div className="min-h-screen px-20 py-20 flex">
        ...
        <div className="w-1/2 ">
          <h1 className=" text-[8vw] uppercase font-[FoundersGrotesk] ">
            presentations
          </h1>
          <div className="flex justify-between ">
            <div className="flex flex-col gap-[2vw]">
              ...
              <ul className="mt-8">
                ...
                <li className="underline">123 street</li>
                <li className="underline">New Delhi India</li>
              </ul>
              <ul className="mt-8">
                <li className="mb-4 ">E:</li>
                <li className="underline">ak.dev2004@gmail.com</li>
              </ul>
              <div className="mt-25">© ochi design 2025. Legal Terms</div>
            </div>
            <div className="self-end">
              <ul>
                <li className="uppercase mb-4">M:</li>
              ...
              <div className="mt-25">Website by Obys</div>
            </div>
          </div>
        </div>
      </div>
